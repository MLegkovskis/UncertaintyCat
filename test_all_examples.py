...
def run_monte_carlo_check(model, problem, n_samples=100):
    """
...
def run_example_check(file_path):
    """
    ...
    try:
        ...
        mc_success = run_monte_carlo_check(model, problem)
        if mc_success:
...
def main():
    ...
    for i, file_name in enumerate(example_files):
        ...
        success = run_example_check(file_path)
