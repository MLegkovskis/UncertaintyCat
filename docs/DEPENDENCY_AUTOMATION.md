...
| #69                | Grouped routine Pydantic, Pytest, and Ruff uv update.                                                                                                                             | Passed every gate and auto-merged. Its exact-SHA post-merge CI exposed a release-dispatch expression bug, which was traced through subsequent live dispatch tests and corrected without relaxing any gate.                                 |
