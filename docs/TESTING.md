...
- concise Model Understanding, primary/fallback model policy, single-flight polling, explicit uncharged timeout/failure states, dedicated surrogate promotion, dedicated Morris screening/reduction, and Distribution Fitting composition with beam sample data;
