...
- State the input-output shape and OpenTURNS function type.
...
- Describe the pilot minimum, maximum, mean, standard deviation, and 5th-to-95th percentile interval when supplied. Explicitly call this a small validation pilot, not a converged uncertainty analysis.
