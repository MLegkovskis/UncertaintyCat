      ...
      <div className="chat-messages" aria-live="polite" aria-busy={sending}>
        ...
        {messages.map((message, index) => (
          <div className={`chat-message ${message.role}`} key={index}>
            ...
            {message.content ? <Markdown evidenceCitations={message.role === "assistant"}>{message.content}</Markdown> : <div className="assistant-placeholder"><span /><span /><span /> Analysing persisted evidence…</div>}
          </div>
        ))}
      </div>
