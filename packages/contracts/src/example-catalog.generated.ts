    ...
    "equations": [
      {
        ...
        "latex": "P_{r}=\\frac{1}{2}\\rho C_{d}A_{f}v^{3}+C_{rr}m g v"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "Y=\\frac{2\\pi T_{u}(H_{u}-H_{l})}{\\ln(r/r_{w})\\left[1+\\frac{2LT_{u}}{\\ln(r/r_{w})r_{w}^{2}K_{w}}+\\frac{T_{u}}{T_{l}}\\right]}"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\sigma=R-\\frac{C}{\\Gamma}\\left(e^{-\\Gamma\\varepsilon}-1\\right)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "k=k_{0}\\exp\\left(-\\frac{E}{RT}\\right)"
      },
      {
        "outputName": "Conversion",
        "latex": "X=\\frac{C_{A0}-C_A}{C_{A0}}=\\frac{kV}{Q+kV},\\qquad Q=1"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\frac{d^{2}T}{dr^{2}}=-\\frac{h\\left(T-300\\right)}{kr}+\\frac{Q}{k\\ell}"
      },
      {
    ...
    "equations": [
      {
        ...
        "latex": "\\omega_p=\\sqrt{\\frac{k_p}{m_p}},\\qquad\\omega_s=\\sqrt{\\frac{k_s}{m_s}}"
      },
      {
        "outputName": "Auxiliary oscillator terms",
        "latex": "\\gamma=\\frac{m_s}{m_p},\\quad\\omega_a=\\frac{\\omega_p+\\omega_s}{2},\\quad\\zeta_a=\\frac{\\zeta_p+\\zeta_s}{2},\\quad\\theta=\\frac{\\omega_p-\\omega_s}{\\omega_a}"
      },
      {
        "outputName": "Mean-square relative displacement",
        "latex": "\\mathbb{E}[x_s^2]=\\frac{\\pi S_0}{4\\zeta_s\\omega_s^3}\\frac{\\zeta_a\\zeta_s}{\\zeta_p\\zeta_s(4\\zeta_a^2+\\theta^2)+\\gamma\\zeta_a^2}\\frac{(\\zeta_p\\omega_p^3+\\zeta_s\\omega_s^3)\\omega_p}{4\\zeta_a\\omega_a^4}"
      },
      {
        "outputName": "Performance function",
        "latex": "g=F_s-3k_s\\sqrt{\\mathbb{E}[x_s^2]}"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\frac{dS}{dt}=-\\frac{\\beta SI}{N},\\qquad\\frac{dI}{dt}=\\frac{\\beta SI}{N}-\\gamma I,\\qquad\\frac{dR}{dt}=\\gamma I"
      },
      {
        "outputName": "Peak infected population",
        "latex": "Y=\\max_{0\\leq t\\leq t_{\\max}} I(t)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "Y=\\sin(x_1)+7\\sin^2(x_2)+0.1x_3^4\\sin(x_1)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "s=\\max\\left(\\frac{8\\gamma\\phi R_s}{\\pi G b^2},0\\right),\\quad b=2.54\\times10^{-9},\\quad\\sigma_c=\\max\\left(\\frac{1}{10^6}\\left|\\frac{M\\gamma}{2b}(\\sqrt{s}-\\phi)\\right|,10^{-6}\\right)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "Y=\\sum_{i=1}^{20}\\beta_iw_i+\\sum_{i<j}\\beta_{ij}w_iw_j+\\sum_{i<j<k}\\beta_{ijk}w_iw_jw_k+5w_1w_2w_3w_4"
      },
      {
      ...
      },
      {
        ...
        "latex": "\\beta_i=\\begin{cases}20,&i\\leq10\\\\(-1)^i,&i>10\\end{cases},\\quad\\beta_{ij}=\\begin{cases}-15,&i,j\\leq6\\\\(-1)^{i+j},&\\text{otherwise}\\end{cases},\\quad\\beta_{ijk}=\\begin{cases}-10,&i,j,k\\leq5\\\\0,&\\text{otherwise}\\end{cases}"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\Delta t=\\frac{T}{252},\\qquad\\Sigma=\\sigma^2\\Delta t\\left[\\rho\\mathbf{1}\\mathbf{1}^{\\mathsf T}+(1-\\rho)I\\right],\\quad \\rho=0.5,\\quad LL^{\\mathsf T}=\\Sigma"
      },
      {
        "outputName": "Portfolio value",
        "latex": "V=S_0\\exp\\left(\\mathbf{1}^{\\mathsf T}(\\mu\\Delta t\\,\\mathbf{1}+LZ)\\right)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\Delta v=v_e\\ln\\left(\\frac{m_0}{m_0-m_f}\\right)"
      },
      {
        "outputName": "Maximum altitude",
        "latex": "h_{\\max}=\\frac{\\left[\\Delta v\\sin(\\theta\\pi/180)\\right]^2}{2g}"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "P=GA\\eta\\left[1+\\beta(T_{cell}-T_{ref})\\right]"
      }
    ]
  },
  {
    ...
    "equations": [
      ...
      },
      {
        ...
        "latex": "N_{xy}^{\\mathrm{MPa}}=10^9\\frac{k_{xy}\\pi^2D}{b_0^2}\\left[1+\\frac{2p(h-2h_0)-h_c(f_1-f_2)}{4h_0\\ell}\\right]"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\Delta\\tau=\\max\\left(\\frac{x-m}{\\varepsilon\\phi m},0\\right)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\widehat E_i=\\max(10^9E_i,10^{-12}),\\quad\\widehat A_i=\\max(10^{-4}A_i,10^{-12}),\\quad\\widehat P_i=10^3P_i"
      },
      {
        "outputName": "Midspan deflection",
        "latex": "y=-\\frac{\\sqrt{2}(2\\widehat P_1+6\\widehat P_2+10\\widehat P_3+10\\widehat P_4+6\\widehat P_5+2\\widehat P_6)}{\\widehat A_2\\widehat E_2}-\\frac{36\\widehat P_1+100\\widehat P_2+140\\widehat P_3+140\\widehat P_4+100\\widehat P_5+36\\widehat P_6}{\\widehat A_1\\widehat E_1}"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "\\omega_0=\\sqrt{\\frac{C_1+C_2}{M}}"
      },
      {
        "outputName": "Performance function",
        "latex": "Y=3R-\\left|\\frac{2F_1}{M\\omega_0^2}\\sin\\left(\\frac{\\omega_0T_1}{2}\\right)\\right|"
      }
    ]
  },
  {
    ...
    "equations": [
      ...
      },
      {
        ...
        "latex": "Y=\\max_{0\\leq t\\leq12}z(t)"
      }
    ]
  },
  {
    ...
    "equations": [
      {
        ...
        "latex": "P=\\frac{1}{2}\\rho_{air}A C_p\\cos(\\beta\\pi/180)v_{wind}^{3}\\eta"
      }
    ]
  }
